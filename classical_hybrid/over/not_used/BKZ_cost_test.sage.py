# This file was *autogenerated* from the file BKZ_cost_test.sage
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_0p366078 = RealNumber('0.366078'); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_60 = Integer(60); _sage_const_0p00405892 = RealNumber('0.00405892'); _sage_const_0p000784314 = RealNumber('0.000784314'); _sage_const_256 = Integer(256); _sage_const_1 = Integer(1); _sage_const_1p006 = RealNumber('1.006'); _sage_const_34p9018 = RealNumber('34.9018'); _sage_const_0p292 = RealNumber('0.292'); _sage_const_0p337913 = RealNumber('0.337913'); _sage_const_6p125 = RealNumber('6.125')
gp.read("bkzsim.gp")
...
print bkzcosts(_sage_const_256 ,_sage_const_1p006 )
